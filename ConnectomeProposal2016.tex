...
{\bf OEFOS 2012 Discipline:} 102 Computer Science - 033  Data Mining \todo{@Andreas: Which discipline would this fall under?}
\\[0,2cm]
...
\todo{@Bernd: Do you think there should be more here? I can't think of anything particular that's missing, but it seems slightly incomplete...}
...
\textbf{Tasks:} \todo{@Bernd: Write this up.}

\textbf{Deliverables:} \todo{@Bernd: Write this up.}
...
A tool will be created to allow researched to easily and quickly start simulations and affect them in real time. This tool will be made available via an open-source licence such as the MIT licence to facilitate easier studies in future. \todo{@Bernd: Is the MIT licence ok?}
\\[0,2cm]
...
An increased understanding of of neuronal computations based on a better understanding of connectomics would also lend itself to a large variety of engineering applications. As an example, the motion detection circuit of \emph{Drosophila melanogaster} has been identified, which brings with it the potential to include these findings in motion detection solutions \citep{Takemura2013}. \todo{@Bernd: I don't seem to be able to find some way of bringin the tumor growth stuff into this. Any ideas?}
...
\\[0.3cm]
\bibliography{Bibliography,BibliographyPlus,graph_perturbation_resilience}
