%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % X-CORESIM-Proposal-2017-02-01 LAST MODIFIED 07.02.2017 08:35 CET by ah - 
...
%At the very beginning it must be convincing what is the main question and why is this ground breaking and will provide new results - the framework is a "by-product" of value of the others - always consider that the reviewer is part of the community: He must have a clear benefit if he grants this project.
...
%Even before this publication, \citep{Samatova2008GraphPerturbationScalableAlgorithms} have already introduced their "Graph Perturbation Theory" which states that if a solution to a reference graph is known, exact solutions for graph measures of perturbed graphs can be found by computing the difference set; they proved their theory on the Maximal Clique enumeration problem using efficient indexing which lead to an 80\% decrease in computational cost compared to traditional methods. Although this insight is not vital for our project starting with \emph{c.elegans}, it might prove useful when expanding to more complex connectomes.
%\\[0,2cm]
